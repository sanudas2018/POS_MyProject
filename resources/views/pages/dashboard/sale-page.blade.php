            ...
            <div class="shadow-sm h-100 bg-white rounded-3 p-3">
                <table class="table table-sm w-100" id="customerTable">
                    ...
                    <tbody class="w-100" id="customerList">
                        <!-- Loop All Customer Data -->
                    </tbody>
                </table>
            </div>
        </div>
<!-- End All Customer Section -->
